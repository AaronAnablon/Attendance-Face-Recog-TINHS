...
2. Create a Room or Section.
3. Give the Room or Section unique ID to your students.
...
6. After all student enrolled, select a Room or Section and take the attendance.
...
9. Only those enrol in the particular Room or Section will be counted into dataset for facial classification.
...
14. Visualize the attendance data in "Attendance History", or you can enter a particular Room or Section and click "View Attendance History".
15. You can "Warn" or "Kick" the student out of a Room or Section.
16. The face photo of the student who is kicked out will not be counted next time taking the attendance.

### Student
1. Register an account.
2. Enrol a Room or Section.
...
8. When your lecturer take the attendance of a particular Room or Section, all your uploaded facial data will be counted into the dataset for facial comparison.
9. Visualize the attendance data in "Attendance History", or you can enter a particular Room or Section and click "View Attendance History".
